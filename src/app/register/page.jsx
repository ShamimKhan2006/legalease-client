...
//           <Input name="name" label="Full Name" placeholder="Enter Your Name" variant="bordered" className="text-white w-full rounded-xl  bg-blue-500"/>
//           <label className='text-white '>Email</label>
//           <Input name="email" type="email" label="Email" placeholder="Enter your Email" variant="bordered"  className="w-full rounded-xl  bg-blue-500"/>
//             <label className='text-white '>Image</label>
//             <Input name="img" type="img" label="Email" placeholder="Enter  Your Image" variant="bordered"  className="w-full rounded-xl  bg-blue-500"/>
...
//           <Input type="password" label="Password" value={password} onChange={(e) => setPassword(e.target.value)} variant="bordered"  className="w-full rounded-xl bg-blue-500"/>
//           <label className='text-white '>Confirm Password</label>
//           <Input type="password" label="Confirm Password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} variant="bordered"  className="w-full rounded-xl  bg-blue-500"/>
...
const RegisterPage = () => {
  ...
  const inputFocus = (e) =>
    (e.target.style.border = "1.5px solid rgba(96,165,250,0.7)");
  const inputBlur = (e) =>
    (e.target.style.border = "1.5px solid rgba(96,165,250,0.25)");
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            {/* <div className="flex flex-col gap-2">
              ...
              >
                <Radio value="user" classNames={{ label: "text-white" }}>
                  User
                </Radio>
                <Radio value="lawyer" classNames={{ label: "text-white" }}>
                  Lawyer
                </Radio>
              </RadioGroup>
            </div> */}
...
// //               <div
// //                 className="w-full rounded-xl flex items-center gap-3 cursor-pointer transition-all duration-200 px-4"
// //                 style={{ ...inputStyle, height: "52px", border: "1.5px dashed rgba(96,165,250,0.4)" }}
// //                 onClick={() => fileInputRef.current.click()}
// //               >
// //                 <input
...
// //               >
// //                 <Radio value="user" classNames={{ label: "text-white" }}>User</Radio>
// //                 <Radio value="lawyer" classNames={{ label: "text-white" }}>Lawyer</Radio>
// //               </RadioGroup>
// //             </div>
...
// import { authClient } from "@/lib/auth-client";
// import { FcGoogle } from "react-icons/fc";
// import { Radio, RadioGroup, Input, Button } from "@heroui/react";
// import { HiBriefcase, HiPhotograph } from "react-icons/hi";
...
//       name: formData.name,
//       image: imgUrl,
//       additionalData: { role: formData.role },
//     });
...
//   return (
//     <div className="min-h-screen flex items-center justify-center p-4 bg-[#001f3f]">
//       <div className="w-full max-w-md bg-[#001e41] p-8 rounded-3xl border border-blue-400/20 shadow-2xl">
//         <div className="text-center mb-6">
//           <h1 className="text-2xl font-bold text-white">Create Account</h1>
//         </div>

//         <form onSubmit={handleSubmit} className="flex flex-col gap-4">
//           <Input name="name" label="Full Name" placeholder="Enter name" variant="bordered" onChange={handleInputChange} />
//           <Input name="email" label="Email" type="email" variant="bordered" onChange={handleInputChange} />
          
//           <div className="border border-dashed border-blue-400/50 rounded-xl p-3 cursor-pointer text-center" 
//                onClick={() => fileInputRef.current.click()}>
//             <input ref={fileInputRef} type="file" className="hidden" onChange={handleImageUpload} />
//             <span className="text-blue-300 text-sm flex items-center justify-center gap-2">
//               <HiPhotograph /> {imgUrl ? "Image Uploaded" : "Upload Photo"}
//             </span>
//           </div>

//           <RadioGroup label="Select Role" defaultValue="user" orientation="horizontal" 
//             onValueChange={(val) => setFormData({ ...formData, role: val })}>
//             <Radio value="user">User</Radio>
//             <Radio value="lawyer">Lawyer</Radio>
//           </RadioGroup>

//           <Input name="password" label="Password" type="password" variant="bordered" onChange={handleInputChange} />
//           <Input name="confirmPassword" label="Confirm Password" type="password" variant="bordered" onChange={handleInputChange} />
